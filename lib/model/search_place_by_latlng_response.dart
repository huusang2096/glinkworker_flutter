...
//
//     final searchPlaceByLatLngResponse = searchPlaceByLatLngResponseFromJson(jsonString);

import 'dart:convert';

class SearchPlaceByLatLngResponse {
  SearchPlaceByLatLngResponse({
    this.plusCode,
    this.results,
    this.status,
  });
  ...
  factory SearchPlaceByLatLngResponse.fromRawJson(String str) =>
      SearchPlaceByLatLngResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory SearchPlaceByLatLngResponse.fromJson(Map<String, dynamic> json) =>
      SearchPlaceByLatLngResponse(
